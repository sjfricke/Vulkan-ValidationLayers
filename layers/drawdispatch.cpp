...
static const std::map<CMD_TYPE, DrawDispatchVuid> drawdispatch_vuid = {
    ...
    {CMD_NONE, {kVUIDUndefined, kVUIDUndefined, kVUIDUndefined, kVUIDUndefined, kVUIDUndefined, kVUIDUndefined, kVUIDUndefined, kVUIDUndefined, kVUIDUndefined, kVUIDUndefined}}
};
// clang-format on
